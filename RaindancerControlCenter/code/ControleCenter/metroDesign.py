# http://code.activestate.com/recipes/580729-metro-ui-tkinter/
...
class Metro_ButtonLabel(Label):
    def __init__(self, master, text, background, ID=None, foreground="white", opacity=0.8, font=None, command=None,
                 padx=7, pady=7):
        Label.__init__(self, master, ID=ID, text=text, background=background, foreground=foreground, padx=padx,
                       pady=pady)
        if font:
...
class Metro_Button(Button):
    def __init__(self, master, text, background, ID=None, foreground="white", opacity=0.8, font=None, command=None,
        ...
        Button.__init__(self, master, ID=ID, text=text, activebackground=activebackground, background=background,
                        activeforeground=foreground, foreground=foreground, relief=FLAT, padx=padx, pady=pady,
...
class Metro_Entry(Frame):
    ...
    def __init__(self, master, width=None, placeholder=None, placeholder_font=None, placeholder_color="grey",
                 highlightthickness=1, state=NORMAL, font=None, ID=None):
...
class Search_Box(Frame):
    def __init__(self, master, button_text="Search", button_ipadx=16, button_background="#009688",
                 button_foreground="white", button_font=None, opacity=0.8, placeholder=None, placeholder_font=None,
                 placeholder_color="grey", entry_highlightthickness=1, entry_width=30, entry_font=None, command=None,
                 ID=None):
...
class Link_Button(Label):
    def __init__(self, master, text, background=None, font=None, familiy=None, size=None, underline=True,
                 visited_fg="#551A8B", normal_fg="#0000EE", visited=False, action=None, ID=None):
...
class QuoteFrame(Frame):
    ...
    def __init__(self, master=None, text=None, ID=None):
        ...
        self.body = Container(self, background=self.CONTENT_BACKGROUND, padx=self.CONTENT_PADDING,
...
class Metro_LabelFrame(Frame):
    ...
    def __init__(self, master, title, ID=None):
        ...
        self._title = title
        self._title_label = tk.Label(header, text=title, foreground=self.HEADER_FOREGROUND,
                                     background=self.HEADER_BACKGROUND, font=self.FONT_HEADER)
        self._title_label.pack(anchor=W)

        self.body = Container(self, padx=self.INNER_PADDING, pady=self.INNER_PADDING,
...
class Metro_Panel(Frame):
    def __init__(self, master, title, header_color, border_color, width=None, ID=None):
        Frame.__init__(self, master, ID=ID, highlightbackground=border_color, highlightcolor=border_color,
...
class Metro_Checkbutton(tk.Checkbutton):
    ...
    def __init__(self, master, size=22, **kw):
        ...
        tk.Checkbutton.__init__(self, master, indicatoron=0, background=background, activebackground="white",
                                selectimage=selectimage, image=image, highlightthickness=0, **kw)
...
class Metro_Radiobutton(tk.Radiobutton):
    ...
    def __init__(self, master, size=22, **kw):
        ...
        background = get_background_of_widget(master)
        tk.Radiobutton.__init__(self, master, indicatoron=0, background=background, selectcolor=background,
                                activebackground=background, selectimage=selectimage, image=image, highlightthickness=0,
                                borderwidth=0, **kw)
